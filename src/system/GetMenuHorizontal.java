 ...
 *
 */
public class GetMenuHorizontal {
	...
	public static String renderVisualizacao(MenuConstructor mc, boolean portal, int lingua){
		...
		for (int i=0; i<itens.size(); i++) {
			...
			if (parentMenu != mi.parentId) {
				...
				bf.append("screenposition=midle;").append("\n");	
				bf.append("left=offset=0;").append("\n");
				//bf.append("bgimage=/imgrelato/botao.gif;").append("\n");
				//bf.append("borderstyle=solid;").append("\n");
				//bf.append("fontfamily=Helvetica;").append("\n");
				//bf.append("fontsize=80%;").append("\n");
				//bf.append("fontweight=bold;").append("\n");
				//bf.append("separatorcolor=transparency;").append("\n");
				//bf.append("separatorsize=5;").append("\n");
				//bf.append("padding=4;").append("\n");
				//bf.append("imagepadding=4;").append("\n");
				bf.append("itemheight=20;").append("\n");
				bf.append("itemwidth=100;").append("\n");
				//bf.append("offcolor=#000000;").append("\n");
				//bf.append("visitedcolor=#000000").append("\n");
				//bf.append("oncolor=#333333;").append("\n");
				//bf.append("pagecolor=#842C29;").append("\n");
				*/
